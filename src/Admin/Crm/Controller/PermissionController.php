...
use App\Crm\Transport\Event\PermissionSectionsEvent;
...
{
    public const string TOKEN_NAME = 'user_role_permissions';
    ...
    public function savePermission(Role $role, string $name, bool $value, string $csrfToken, PermissionService $permissionService, CsrfTokenManagerInterface $csrfTokenManager): Response
    {
        ...
        if ($value === false && $role->getName() === User::ROLE_SUPER_ADMIN && array_key_exists($name, RolePermissionManager::SUPER_ADMIN_PERMISSIONS)) {
