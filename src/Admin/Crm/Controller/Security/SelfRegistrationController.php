...
use App\Crm\Transport\Event\EmailSelfRegistrationEvent;
use App\Crm\Transport\Form\SelfRegistrationForm;
...
final class SelfRegistrationController extends AbstractController
{
    ...
    private function generateConfirmationEmail(User $user, TranslatorInterface $translator): Email
    {
        ...
        return (new TemplatedEmail())
            ...
            ->subject(
                $translator->trans('registration.subject', [
                    '%username%' => $username,
                ], 'email', $language)
            )
