...
final class UserController extends BaseApiController
{
    ...
    #[Route(methods: ['GET'], path: '/{id}', name: 'get_user', requirements: [
        'id' => '\d+',
    ])]
    ...
    #[Route(methods: ['PATCH'], path: '/{id}', name: 'patch_user', requirements: [
        'id' => '\d+',
    ])]
    ...
    #[Route(methods: ['DELETE'], path: '/api-token/{id}', name: 'delete_api_token', requirements: [
        'id' => '\d+',
    ])]
