...
use App\Calendar\Application\Utils\Command\CommandHelper;
use App\Calendar\Application\Utils\Constants\CommandData;
...
{
    final public const string COMMAND_NAME = 'db:reinitialize';

    final public const string COMMAND_DESCRIPTION = 'Reinitialize the test or prod db.';

    final protected const string NAME_OPTION_SCHEMA_DROP = 'schema-drop';

    final protected const string NAME_OPTION_SCHEMA_DROP_SHORT = 'd';

    final protected const string NAME_OPTION_CREATE_SCHEMA = 'create-schema';

    final protected const string NAME_OPTION_CREATE_SCHEMA_SHORT = 'c';

    final protected const string NAME_OPTION_LOAD_FIXTURES = 'load-fixtures';

    final protected const string NAME_OPTION_LOAD_FIXTURES_SHORT = 'l';

    final protected const string NAME_OPTION_ENVIRONMENT = 'env';
