...
use App\Calendar\Application\Utils\GPSConverter;
use App\Calendar\Application\Utils\SizeConverter;
use App\Calendar\Application\Utils\StringConverter;
use DateTime;
use DateTimeImmutable;
use Exception;
use JetBrains\PhpStorm\ArrayShape;

use function App\Service\gettype;
...
class ImageDataService
{
    ...
    final public const string KEY_NAME_VALUE_ORIGINAL = 'value-original';

    final public const string KEY_NAME_VALUE_FORMATTED = 'value-formatted';

    final public const string KEY_NAME_VALUE_DATE_TIME = 'value-date-time';

    final public const string KEY_NAME_DEVICE_MANUFACTURER = 'device-manufacturer';
    final public const string KEY_NAME_DEVICE_MODEL = 'device-model';

    final public const string KEY_NAME_EXIF_VERSION = 'exif-version';

    final public const string KEY_NAME_IMAGE_APERTURE = 'image-aperture';
    final public const string KEY_NAME_IMAGE_DATE_TIME_ORIGINAL = 'image-date-time-original';
    final public const string KEY_NAME_IMAGE_EXPOSURE_BIAS_VALUE = 'image-exposure-bias-value';
    final public const string KEY_NAME_IMAGE_EXPOSURE_TIME = 'image-exposure-time';
    final public const string KEY_NAME_IMAGE_FILENAME = 'image-filename';
    final public const string KEY_NAME_IMAGE_FOCAL_LENGTH = 'image-focal-length';
    final public const string KEY_NAME_IMAGE_HEIGHT = 'image-height';
    final public const string KEY_NAME_IMAGE_ISO = 'image-iso';
    final public const string KEY_NAME_IMAGE_MIME = 'image-mime';
    final public const string KEY_NAME_IMAGE_SIZE = 'image-size';
    final public const string KEY_NAME_IMAGE_SIZE_HUMAN = 'image-size-human';
    final public const string KEY_NAME_IMAGE_WIDTH = 'image-width';
    final public const string KEY_NAME_IMAGE_X_RESOLUTION = 'image-x-resolution';
    final public const string KEY_NAME_IMAGE_Y_RESOLUTION = 'image-y-resolution';

    final public const string KEY_NAME_GPS_GOOGLE_LINK = 'gps-google-link';
    final public const string KEY_NAME_GPS_HEIGHT = 'gps-height';
    final public const string KEY_NAME_GPS_LATITUDE_DMS = 'gps-latitude-dms';
    final public const string KEY_NAME_GPS_LATITUDE_DECIMAL_DEGREE = 'gps-latitude-decimal-degree';
    final public const string KEY_NAME_GPS_LATITUDE_DIRECTION = 'gps-latitude-direction';
    final public const string KEY_NAME_GPS_LONGITUDE_DMS = 'gps-longitude-dms';
    final public const string KEY_NAME_GPS_LONGITUDE_DECIMAL_DEGREE = 'gps-longitude-decimal-degree';
    ...
    public function __construct(
        ...
        protected ?\App\Calendar\Application\Service\Entity\PlaceLoaderService $placeLoaderService = null,
        protected ?\App\Calendar\Application\Service\LocationDataService $locationDataService = null,
        bool $debug = false,
        bool $verbose = false
    ) {
