...
use App\Calendar\Application\Service\Entity\Base\BaseLoaderService;
use App\Calendar\Application\Service\SecurityService;
...
class CalendarLoaderService extends BaseLoaderService
{
     ...
     * @throws Exception
     */
    public function loadUser(string $userEmailOrId, bool $clearObjects = true): User
    {
        /* Clears all objects */
        if ($clearObjects) {
            $this->clear();
